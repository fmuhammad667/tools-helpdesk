<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @role('admin')
            ...
            <!-- PARAMETER -->
            <li class="nav-item">
                <a href="{{ route('admin.jenis_parameter.index') }}"
                    class="nav-link {{ Route::is('admin.jenis_parameter.index') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-th"></i>
                    <p>Jenis Parameter
                        <span class="badge badge-warning right">{{ $JenisParameterCount }}</span>
                    </p>
                </a>
            </li>
            ...
            <!-- RESULT -->
            <li class="nav-item">
                <a href="{{ route('admin.jenis_result.index') }}"
                    class="nav-link {{ Route::is('admin.jenis_result.index') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-th"></i>
                    <p>Jenis Result
                        <span class="badge badge-warning right">{{ $JenisResultCount }}</span>
                    </p>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{{ route('admin.aplikasi.index') }}"
                    class="nav-link {{ Route::is('admin.aplikasi.index') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-th"></i>
                    <p>Aplikasi
                        <span class="badge badge-warning right">{{ $AplikasiCount }}</span>
                    </p>
                </a>
            </li>
        @endrole
